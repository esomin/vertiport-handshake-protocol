...
* **Language:** TypeScript (FastAPI/asyncio)
...
| App 명칭 | 역할 요약 | 주요 기술 | 상세 문서 |
|----------|----------|----------|----------|
| Simulator | 다수의 가상 UAM 기체 상태를 생성·송신하는 시뮬레이터 | TypeScript, MQTT | [simulator/README.md](app/simulator/README.md) |
| Gateway | MQTT 메시지를 수집·중계하는 게이트웨이 | MQTT, gRPC, mTLS | [gateway/README.md](app/gateway/README.md) |
| Scheduler | 우선순위 계산 및 착륙 스케줄링 엔진 | TypeScript, Redis ZSET | [scheduler/README.md](app/scheduler/README.md) |
| Dashboard | 실시간 관제 대시보드 및 명령 하달 UI | React, WebSocket, shadcn/ui | [dashboard/README.md](app/dashboard/README.md) |
